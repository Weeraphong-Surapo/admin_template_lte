...
<div
  ...
  <div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 925px;"></div>
  ...
  <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
    <div class="os-scrollbar-track">
      <div class="os-scrollbar-handle" style="height: 56.2234%; transform: translate(0px, 0px);"></div>
    </div>
  </div>
